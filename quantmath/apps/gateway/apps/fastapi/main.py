...
# ===== CORS =====
# Allow Vercel frontend, Render deployments + localhost (dev)
origins = [
    ...
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://localhost:8080",     # <--- added for your current frontend
    "http://127.0.0.1:8080",     # <--- added for your current frontend
]
app.add_middleware(
    CORSMiddleware,
